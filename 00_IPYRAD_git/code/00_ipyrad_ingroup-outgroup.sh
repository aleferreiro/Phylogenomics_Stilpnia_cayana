...
####################################################
###### Ingroup-outgroup 84 samples dataset ##################
...
ipyrad -p params-Tangara_2023_84-II.txt -s 2

###### Step 3 ##################
# Clustering and mapping within individuals
ipyrad -p params-Tangara_2023_84-II.txt -s 3
...
ipyrad -p params-Tangara_2023_84-II.txt -s 4

###### Step 5 ##################
# Generate consensus sequences per cluster
ipyrad -p params-Tangara_2023_84-II.txt -s 5

###### Step 6 ##################
# Inter-individual clustering and multiple sequence alignment
# Before step 7, update the parameter file:
# Set 'min_samples_locus' to retain loci present in ~80% of individuals.

# Run step 6 only after adjusting this parameter.
ipyrad -p params-Tangara_2023_84-II.txt -s 6


###### Step 7 ##################
# Output assembled files
ipyrad -p params-Tangara_2023_84-II.txt -s 7