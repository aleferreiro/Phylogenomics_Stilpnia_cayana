...
bs_params <- read.table("06_fastsimcoal2/result/Model_18_MSFSrecal/bs_params.txt",
                        header = T)
...
# Estimate confidence intervals for each parameter
...
write_csv(result_fsc_Ne,
          file = "06_fastsimcoal2/result/Model_18_MSFSrecal/bs_result_Ne.csv")
write_csv(result_fsc_Tdiv,
          file = "06_fastsimcoal2/result/Model_18_MSFSrecal/bs_result_Tdiv.csv")
write_csv(result_fsc_Mig,
          file = "06_fastsimcoal2/result/Model_18_MSFSrecal/bs_result_Mig.csv")
...
Mig_gtTable <- Mig_table |> 
  ...
  fmt_number(columns = everything(),
             decimals = 3) |> 
  tab_source_note(
    source_note = md("Model 16: Results obtained generating SFS with 6 
...
# Save it as an image
gtsave(Mig_gtTable,
       "06_fastsimcoal2/plot/Model_18_SFSrecal/Mig_table_CI.png")



# 5. Table with effective sizes and divergence times ----------------------

Parameters_vector <- c("Ne Guyana", "Ne Pará-Amapa","Ne North",
                       "Ne Marajo", "Ne Caatinga", "Ne West",
...
gtsave(NeTdiv_gtTable,
       "06_fastsimcoal2/plot/Model_18_SFSrecal/NeTdiv_table_CI.png")
